...
# WORK IN PROGRESS - Use with care, for now!

Novicell build is a framework for your frontend setup. This setup helps developers by automizing frontend workflow using certain technologies like NPM Scripts and Webpack.
...
3. Insert paths/variables to config.js [Configuration and paths](#configuration-and-paths)
